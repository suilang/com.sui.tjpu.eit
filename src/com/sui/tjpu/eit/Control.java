...
public class Control extends ViewPart {
	...
	public void createPartControl(Composite parent) {
		...
		fd_composite_1.bottom = new FormAttachment(composite1, 135, SWT.BOTTOM);
		...
		currentframeText = new Text(composite_1, SWT.BORDER);
		currentframeText.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true,
				false, 1, 1));
		currentframeText.setText(String.valueOf(mycalpara.getCurrentIndex()+1));

		Button btnNewButton2 = new Button(composite_1, SWT.NONE);
		btnNewButton2.addSelectionListener(new SelectionAdapter() {

			public void widgetSelected(SelectionEvent e) {
				mycalpara.setCurrentIndex(Integer.parseInt(IterationText.getText()
						.toString()));
			}
		});
		...
		totalframeText = new Text(composite_1, SWT.BORDER);
		...
		fd_composite_2.bottom = new FormAttachment(composite_1, 80, SWT.BOTTOM);
		fd_composite_2.top = new FormAttachment(composite_1, 6);
		fd_composite_2.right = new FormAttachment(0, 241, SWT.RIGHT);
